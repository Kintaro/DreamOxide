...
pub enum Instruction {
    ...
    ExtUB(Operand, Operand),
    ExtUW(Operand, Operand),
    ExtSB(Operand, Operand),
    ExtSW(Operand, Operand),
    ...
    FMovLoadD8(Operand, Operand),
    FMovStoreS4(Operand, Operand),
